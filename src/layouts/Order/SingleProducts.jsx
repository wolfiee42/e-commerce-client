...
const SingleProducts = ({ product }) => {
    ...
    const item = { email, _id, name, price, image, desc }


    const handleWishlist = () => {
        setwishlist(!wishlist);
        axiosPublic.post('/wishlists', item)
            .then(res => {
    ...
    return (
        <div className="w-[350px] bg-[#E0F5EB] py-5 rounded-md hover:shadow-lg">
            ...
            <div className="flex items-center justify-center mt-5 gap-2">
                <button onClick={handleCartBtn} className="uppercase btn btn-xs md:btn-sm lg:btn bg-[#636940] lg:bg-[#636940] text-white lg:text-white border-b-2 lg:border-b-2 border-[#474A2C] lg:border-[#474A2C] lg:hover:bg-[#555A36] hover:border-none lg:hover:border-none">Add to Cart</button>
