...
const BannerSec = () => {
    return (
        <div className="bg-[#E0F5EB]" >
            <Container>
                <div className="flex flex-col md:flex-row justify-center items-center md:gap-10 md:px-10 min-h-[70vh]">
                    <div className=" space-y-1 md:space-y-2 lg:space-y-3">
                        ...
                        <button className="uppercase btn btn-xs md:btn-sm lg:btn bg-[#636940] lg:bg-[#636940] text-white lg:text-white border-b-2 lg:border-b-2 border-[#474A2C] lg:border-[#474A2C] lg:hover:bg-[#555A36] hover:border-none lg:hover:border-none">Shop Now</button>
                    </div>
